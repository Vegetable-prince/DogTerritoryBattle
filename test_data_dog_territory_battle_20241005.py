...
def load_test_data():
    ...
    DogType.objects.create(name='bulldog', max_steps=1, movement_type='diagonal_orthogonal')
    DogType.objects.create(name='corgi', max_steps=1, movement_type='diagonal_orthogonal')
    DogType.objects.create(name='shepherd', max_steps=1, movement_type='orthogonal')
    DogType.objects.create(name='shiba', max_steps=1, movement_type='diagonal')
    ...
    # game_game テーブルのデータ
    game = Game.objects.create(current_turn_id=2, player1_id=1, player2_id=2, winner_id=None)

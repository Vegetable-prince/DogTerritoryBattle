...
def load_test_data():
    ...
    ContentType.objects.get_or_create(
        app_label="dog_territory_battle_game", model="player"
    )
    ContentType.objects.get_or_create(
        app_label="dog_territory_battle_game", model="dogtype"
    )
    ContentType.objects.get_or_create(
        app_label="dog_territory_battle_game", model="game"
    )
    ContentType.objects.get_or_create(
        app_label="dog_territory_battle_game", model="dog"
    )
    ...
    game = Game.objects.create(
        current_turn_id=2, player1_id=player1.id, player2_id=player2.id, winner_id=None
    )
